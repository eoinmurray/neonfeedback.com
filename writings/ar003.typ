...
#let body = [
  ...
  *Legitimacy* is the property that makes power voluntarily accepted by those subject to it: legitimate power runs on compliance, illegitimate on enforcement. It is a property power can have, not a sixth form: any of the kinds above can be legitimate, illegitimate, or contested. Two senses get confused. _Descriptive_: those subject to it actually accept it as rightful, a fact about behaviour. _Normative_: it meets an external standard (consent, procedural fairness, justice), a claim about what ought to be acceptable. They come apart both ways: a regime can be widely accepted yet unjust (most stable tyrannies), or normatively legitimate yet rejected on the ground (most failed reforms).
]
