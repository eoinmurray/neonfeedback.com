...
#let body = [
  ...
  To test where a thing sits, ask: _if the other layers were varied independently, would this thing vary with them, or hold constant?_ Gravity holds across all societies and all bodies — physical. The calorie requirement of a human body holds across all societies but varies across species — material. Which side of the road cars drive on varies across societies within identical material conditions — social.
  ...
  *Downward causation.* The upper layers reach down and reshape the lower ones. You plant a garden — agent reshapes material. A village decides to build a well — social reshapes material. A revolution overthrows a government — agents reshape the social. The stack is not one-directional. This is what makes it a stack and not just a hierarchy.
  ...
  Downward causation is philosophically contested. If the physical is causally closed, non-physical causes either overdetermine outcomes or are epiphenomenal — they do no work that physics is not already doing. The stack assumes _non-reductive physicalism_: higher-level facts have causal purchase even though they supervene on physical ones. This is the working assumption of most social science. It is adopted here rather than defended. A reader who rejects it will find the rest of the apparatus unmotivated.
  ...
  *Walking.* _Physical_: bipedalism, gravity, friction. _Material_: terrain — mud, mountain, flat plain, river crossing. _Social_: sidewalks, which side of the pavement you walk on, where women can walk alone at night, borders, trespass law. _Agent_: where you choose to go, whether you jaywalk, whether you cross a border illegally. A border is invisible at the physical and material layers — the ground is the same on both sides — but at the social layer it is one of the most powerful structures on earth. People die crossing borders. The dirt does not know.

  *Oil.* _Physical_: chemistry — heat and pressure convert buried organisms into hydrocarbons. _Material_: the oil sits in specific places — the Persian Gulf, the North Sea, West Texas — unevenly distributed by geological accident. _Social_: who owns it, who profits, the decision to build a civilisation around the internal combustion engine. The same barrel could power a public bus or a private jet — that is a social choice. _Agent_: you drive, fly, cycle. Here the layers fold: agent-level consumption, aggregated, reshapes the material — CO₂ accumulates, the climate warms — which constrains future social choices. The stack operating as a loop.
