...
DATA = [
    ...
    ("Cartagena",     1873, 1874, 2.6e4, 0.5,   "crushed"),
    ...
    ("Korea (KPAM)",  1929, 1931, 5.0e4, 2,     "crushed"),  # governed number unknown (2M = Manchurian Korean diaspora, per Hwang 2016); nominal placeholder
    ("Alt Llobregat", 1932, 1932, 3.0e3, 0.016, "crushed"),
    ("Asturias",      1934, 1934, 5.0e5, 0.04,  "crushed"),
    ("Catalonia",     1936, 1939, 6.5e6, 3,     "betrayed"),
    ("Hungary '56",   1956, 1956, 2.0e6, 0.25,  "crushed"),
    ("Marinaleda",    1979, None, 2.7e3, 47,    "alive"),
    ("Gwangju",       1980, 1980, 7.3e5, 0.016, "crushed"),
