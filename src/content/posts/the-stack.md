...
The **social layer** is where it gets interesting. This is the constructed layer — the arrangements humans make collectively, which are constrained by the material but absolutely not determined by it. Two societies with identical material conditions can organise themselves in opposite ways, and historically they often have, sometimes apparently on purpose. The social layer is contingent. It is where power, roles, norms, and institutions live — and this is the layer people tend to mistake for one of the layers below. The social gives rise to agents: a child born into a society with a class system absorbs class as part of who they are before they have the language to question it. **Examples:** which side of the road you drive on, marriage, queuing.
...
**Contingency** — whether something could have been otherwise. If you could rerun humanity from scratch — same bodies, same planet, different initial conditions — the things that come out the same every time are necessary. The things that come out differently are contingent. The physical layer has zero contingency. The material layer has some — which river valley you are born near is geology, not justice. The social layer has a great deal — property law, gender roles, caste could all have gone differently and in many places did. Moving up the stack is moving from the necessary toward the contingent.

**Mutability** — how readily something can be changed. You cannot change gravity. Material conditions take generations — clear a forest, build a dam, industrialise. Social arrangements can change in a lifetime — revolutions, reforms, movements. An agent can change in a moment — a decision, a refusal. Each layer runs on a faster clock than the one below.
...
**Naturalisation.** Something from the social layer is smuggled down to the physical. "Boys will be boys" — social behaviour relocated to the physical layer in four words. "It's human nature to be selfish" — the most popular naturalisation of all, despite massive anthropological evidence to the contrary. It is a move to escape accountability by crossing into a layer where accountability does not apply. A great deal of what passes for common sense is naturalisation that nobody bothered to check.

**Material lock-in.** The social layer builds material infrastructure that then constrains future social choices. Once you have built a car-dependent city, the material layer locks in a social arrangement. A railway gauge, once laid, forces everything that runs on the tracks to match. The social created it, but now the material maintains it. This is why it is much easier to imagine a different society than to build one: the old one has been poured into concrete.

**Internalisation.** The social layer becomes the agent layer when a person absorbs a construction as part of who they are. You lower your voice in a library — nobody is enforcing it, but you would feel like a criminal if you didn't. You feel guilty for not working, even on a day off — the boss is gone but the feeling stayed. The deepest example may be language. You did not choose your first language. It arrived before you could consent to it, it structured how you think, and you cannot unlearn it. Entirely social, yet permanent — the social layer written into the hardware. Internalisation is what makes social constructions durable: they do not feel constructed from the inside. But internalisation is not total — a trans person who rejects the gender assigned to them is demonstrating that the agent layer is not simply a passive receiver.

**Emergence.** Agent-level actions produce patterns that no agent intended. A path forms across a field — nobody planned it, enough people walked the same way and now it is a material-layer fact. The social layer emerges from agents but is not reducible to them, which is why individual intentions are not enough to fix collective outcomes. Emergence also works downward: billions of decisions to burn coal produced a new material reality — more CO₂, a warmer planet. And the material layer itself grows — indoor plumbing started as a luxury, became an expectation, and is now experienced as a need. The stack accretes downward.
